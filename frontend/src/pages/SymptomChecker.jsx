        ...
        <div className="p-5 max-w-4xl mx-auto min-h-[60vh]">
            ...
            <div className="flex justify-center">
                <button
                    ...
                    disabled={loading}
                    className="bg-primary text-white px-10 py-3 rounded-full cursor-pointer hover:bg-blue-600 hover:scale-105 hover:shadow-lg transition-all duration-300 text-lg"
                >
            ...
            {prediction && (
                <div className="mt-12 p-8 bg-blue-50 border border-blue-200 rounded-2xl text-center shadow-sm max-w-2xl mx-auto">
                    ...
                    <button
                        ...
                        className="bg-primary text-white px-8 py-3 rounded-full hover:bg-blue-600 transition-all shadow-md text-lg cursor-pointer"
                    >
